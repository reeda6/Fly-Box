...
class Register extends React.Component {
  ...
  handleSubmit= async event => {
    ...
    for (var pair of data.entries()) {
      ...
      ()=>{
      try {
        console.log(this.state.email,' this is email in handlesubmit', 'this is email1', email1)
       Auth.signUp({
      ...
      axios.post('https://hro28vpqla.execute-api.us-east-1.amazonaws.com/dev/requestUploadURL',
        ...
        .then((param) => {
          ...
          console.log('picture string is this', this.state.pictureString)
              ...
              axios.get('https://hro28vpqla.execute-api.us-east-1.amazonaws.com/dev/getImages',
            {
              email: this.state.email
            })
            .then((obj) => {
  ...
  render() {
    return (
      ...
      <form onSubmit={this.handleConfirmationSubmit}>
          ...
          {console.log('this is the string the image is using', this.state.retrievedString)}
          <div id="list">
